...
const Sidebar = ({ showAddTask, setShowAddTask, searchQuery, setSearchQuery }) => {
    ...
    return (
        <div>
            ...
            <button
                className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-red-500 text-white rounded-full"
            ...
            >
                ...
                <nav className="space-y-1">
                    <Link
                        to="/"
                        className={`flex items-center text-gray-700 px-3 py-2 rounded-lg ${isTodayPage ? 'bg-red-50' : 'hover:bg-gray-100'}`}
                    >
                    ...
                    <Link
                        to="/upcoming"
                        className={`flex items-center text-gray-700 px-3 py-2 rounded-lg ${isUpcomingPage ? 'bg-red-50' : 'hover:bg-gray-100'}`}
                    >
                        <Calendar className="w-5 h-5 mr-3" />
                        Upcoming
                    </Link>
                ...
                {/* Projects Section */}
                <div className="mt-8">
                    <h2 className="text-gray-500 text-sm font-medium mb-2">My Projects</h2>
